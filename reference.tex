...
\framebox[\linewidth]{
	\parbox{\linewidth}{
		...
		\vspace{-6pt}
		Can be called from HTML handlers, \textit{e.g.} an \texttt{onclick} or \texttt{onload} attributes on any tag.
		...
		\hspace*{34pt} \{ alert((first + second)/2); \}}
		\\
		...
		\hspace*{34pt} \{ \textbf{return} (first + second)/2; \}}
		\\
